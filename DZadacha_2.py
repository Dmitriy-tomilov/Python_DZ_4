...
# 1) подсчет ягод на каждом кусте (19 строка)
# 2) прибавляем 3 куста (25 строка)
# 3) невозможно прописать алгоритм для трех кустов, которые находятся перед первым кустом (26 строка)
# 4) выводим Макс